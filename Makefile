...
ft_isalpha.c ft_memcpy.c ft_strchr.c ft_strncmp.c ft_isascii.c \
...
BONUS_SRCS := ft_lstnew.c ft_lstsize.c ft_lstclear.c ft_lstmap.c ft_lstadd_front.c ft_lstadd_back.c ft_lstlast.c ft_lstiter.c ft_lstdelone.c
